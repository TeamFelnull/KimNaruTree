...
public class NotePCBlock extends KNTBlock {
    public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
    public static final BooleanProperty OPEN = BlockStateProperties.OPEN;
    public static final IntegerProperty PHASE = BlockProperties.PHASE_0_4;
    ...
    private static final VoxelShape OPEN_EAST_PART1 = VoxelShapeHelper.makeCuboidShaoe90(13, 0, 0, 3, 0.5d, 16);
    private static final VoxelShape OPEN_EAST_PART2 = VoxelShapeHelper.makeCuboidShaoe90(14, 0, 0, 13, 1, 16);
    private static final VoxelShape OPEN_EAST_PART3 = VoxelShapeHelper.makeCuboidShaoe90(13, 0.5d, 0, 12.5d, 2d, 16);
    private static final VoxelShape OPEN_EAST_PART4 = VoxelShapeHelper.makeCuboidShaoe90(13.5d, 1, 0, 13, 3, 16);
    private static final VoxelShape OPEN_EAST_PART5 = VoxelShapeHelper.makeCuboidShaoe90(14, 2, 0, 13.5d, 4, 16);
    private static final VoxelShape OPEN_EAST_PART6 = VoxelShapeHelper.makeCuboidShaoe90(14.5d, 3, 0, 14, 5, 16);
    private static final VoxelShape OPEN_EAST_PART7 = VoxelShapeHelper.makeCuboidShaoe90(15, 4, 0, 14.5d, 6, 16);
    private static final VoxelShape OPEN_EAST_PART8 = VoxelShapeHelper.makeCuboidShaoe90(15.5d, 5, 0, 15, 7, 16);
    private static final VoxelShape OPEN_EAST_PART9 = VoxelShapeHelper.makeCuboidShaoe90(16, 6, 0, 15.5d, 8, 16);
    private static final VoxelShape OPEN_EAST_PART10 = VoxelShapeHelper.makeCuboidShaoe90(16.5d, 7, 0, 16, 9, 16);
    private static final VoxelShape OPEN_EAST_PART11 = VoxelShapeHelper.makeCuboidShaoe90(17, 8, 0, 16.5d, 9.3d, 16);
    ...
    private static final VoxelShape OPEN_WEST_PART1 = VoxelShapeHelper.makeCuboidShaoe270(13, 0, 0, 3, 0.5d, 16);
    private static final VoxelShape OPEN_WEST_PART2 = VoxelShapeHelper.makeCuboidShaoe270(14, 0, 0, 13, 1, 16);
    private static final VoxelShape OPEN_WEST_PART3 = VoxelShapeHelper.makeCuboidShaoe270(13, 0.5d, 0, 12.5d, 2d, 16);
    private static final VoxelShape OPEN_WEST_PART4 = VoxelShapeHelper.makeCuboidShaoe270(13.5d, 1, 0, 13, 3, 16);
    private static final VoxelShape OPEN_WEST_PART5 = VoxelShapeHelper.makeCuboidShaoe270(14, 2, 0, 13.5d, 4, 16);
    private static final VoxelShape OPEN_WEST_PART6 = VoxelShapeHelper.makeCuboidShaoe270(14.5d, 3, 0, 14, 5, 16);
    private static final VoxelShape OPEN_WEST_PART7 = VoxelShapeHelper.makeCuboidShaoe270(15, 4, 0, 14.5d, 6, 16);
    private static final VoxelShape OPEN_WEST_PART8 = VoxelShapeHelper.makeCuboidShaoe270(15.5d, 5, 0, 15, 7, 16);
    private static final VoxelShape OPEN_WEST_PART9 = VoxelShapeHelper.makeCuboidShaoe270(16, 6, 0, 15.5d, 8, 16);
    private static final VoxelShape OPEN_WEST_PART10 = VoxelShapeHelper.makeCuboidShaoe270(16.5d, 7, 0, 16, 9, 16);
    private static final VoxelShape OPEN_WEST_PART11 = VoxelShapeHelper.makeCuboidShaoe270(17, 8, 0, 16.5d, 9.3d, 16);
    ...
    public static Block instance(ITranslationEnum klang, Material material, SoundType sound, float hardness, float resistance){
        return new NotePCBlock(AbstractBlock.Properties.create(material).sound(sound).hardnessAndResistance(hardness, resistance)).setRegistryName(KimNaruTree.MOD_ID, klang.getKey());
    }
    ...
    public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos,
        ...
        boolean wetWithRain = worldIn.canBlockSeeSky(pos.up()) && worldIn.isRaining();
        if (wetWithRain && phase != 0) {
